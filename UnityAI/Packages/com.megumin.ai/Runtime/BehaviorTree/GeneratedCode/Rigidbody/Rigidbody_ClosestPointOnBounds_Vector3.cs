...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Rigidbody_ClosestPointOnBounds_Vector3 : BTActionNode<UnityEngine.Rigidbody>
    {
        [Space]
        ...
        {
            var result = ((UnityEngine.Rigidbody)MyAgent).ClosestPointOnBounds(position);
