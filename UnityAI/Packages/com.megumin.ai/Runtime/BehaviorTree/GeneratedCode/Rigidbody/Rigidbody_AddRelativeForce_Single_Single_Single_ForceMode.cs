...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Rigidbody_AddRelativeForce_Single_Single_Single_ForceMode : BTActionNode<UnityEngine.Rigidbody>
    {
        [Space]
        ...
        {
            ((UnityEngine.Rigidbody)MyAgent).AddRelativeForce(x, y, z, mode);
