...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Animator_MatchTarget_Vector3_Quaternion_AvatarTarget_MatchTargetWeightMask_Single : BTActionNode<UnityEngine.Animator>
    {
        [Space]
        ...
        {
            ((UnityEngine.Animator)MyAgent).MatchTarget(matchPosition, matchRotation, targetBodyPart, weightMask, startNormalizedTime);
