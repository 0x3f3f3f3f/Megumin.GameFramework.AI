...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Animator_Play_String_Int32_Single : BTActionNode<UnityEngine.Animator>
    {
        [Space]
        ...
        {
            ((UnityEngine.Animator)MyAgent).Play(stateName, layer, normalizedTime);
