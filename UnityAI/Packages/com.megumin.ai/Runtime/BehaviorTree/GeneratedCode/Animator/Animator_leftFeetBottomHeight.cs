...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Animator_leftFeetBottomHeight : CompareDecorator<UnityEngine.Animator, float>
    {
        [Space]
        ...
        {
            var result = ((UnityEngine.Animator)MyAgent).leftFeetBottomHeight;
