...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Animator_MatchTarget_Vector3_Quaternion_AvatarTarget_MatchTargetWeightMask_Single_Single_Boolean : BTActionNode<UnityEngine.Animator>
    {
        [Space]
