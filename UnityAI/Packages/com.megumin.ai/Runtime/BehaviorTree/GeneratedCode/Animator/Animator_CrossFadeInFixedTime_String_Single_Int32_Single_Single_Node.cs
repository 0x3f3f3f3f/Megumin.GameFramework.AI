...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Animator_CrossFadeInFixedTime_String_Single_Int32_Single_Single_Node : BTActionNode<UnityEngine.Animator>
    {
        [Space]
        ...
        {
            ((UnityEngine.Animator)MyAgent).CrossFadeInFixedTime(stateName, fixedTransitionDuration, layer, fixedTimeOffset, normalizedTransitionTime);
