...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Quaternion_SetFromToRotation_Vector3_Vector3 : BTActionNode
    {
        [Space]
        ...
        {
            ((UnityEngine.Quaternion)MyAgent).SetFromToRotation(fromDirection, toDirection);
