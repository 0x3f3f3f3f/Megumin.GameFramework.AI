...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    [Category("Unity/Collider")]
    [AddComponentMenu("contactOffset")]
    public sealed class Collider_contactOffset : CompareDecorator<UnityEngine.Collider, float>
    {
        [Space]
        ...
        {
            var result = ((UnityEngine.Collider)MyAgent).contactOffset;
