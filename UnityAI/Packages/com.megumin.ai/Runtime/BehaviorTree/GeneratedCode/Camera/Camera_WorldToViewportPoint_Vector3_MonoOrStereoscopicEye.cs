...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Camera_WorldToViewportPoint_Vector3_MonoOrStereoscopicEye : BTActionNode<UnityEngine.Camera>
    {
        [Space]
        ...
        {
            var result = ((UnityEngine.Camera)MyAgent).WorldToViewportPoint(position, eye);
