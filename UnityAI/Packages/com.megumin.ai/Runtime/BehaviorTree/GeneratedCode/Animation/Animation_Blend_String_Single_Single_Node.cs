...
namespace Megumin.GameFramework.AI.BehaviorTree
{
    ...
    public sealed class Animation_Blend_String_Single_Single_Node : BTActionNode<UnityEngine.Animation>
    {
        [Space]
        ...
        {
            ((UnityEngine.Animation)MyAgent).Blend(animation, targetWeight, fadeLength);
