...
namespace Megumin.AI.BehaviorTree
{
    ...
    [AddComponentMenu("CircleCast(Vector2, Single, Vector2)")]
    public sealed class Physics2D_CircleCast_Vector2_Single_Vector2_Node : BTActionNode
    {
        [Space]
        ...
        {
            var result = UnityEngine.Physics2D.CircleCast(origin, radius, direction);
