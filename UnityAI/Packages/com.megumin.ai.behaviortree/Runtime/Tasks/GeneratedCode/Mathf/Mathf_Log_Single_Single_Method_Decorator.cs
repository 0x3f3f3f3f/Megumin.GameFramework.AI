...
namespace Megumin.AI.BehaviorTree
{
    ...
    [AddComponentMenu("Log(Single, Single)")]
    public sealed class Mathf_Log_Single_Single_Method_Decorator : CompareDecorator<float>
    {
        [Space]
        ...
        {
            var result = UnityEngine.Mathf.Log(f, p);
