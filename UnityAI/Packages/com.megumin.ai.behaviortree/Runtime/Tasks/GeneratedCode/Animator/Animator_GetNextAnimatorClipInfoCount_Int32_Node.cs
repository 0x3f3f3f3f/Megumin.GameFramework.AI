...
namespace Megumin.AI.BehaviorTree
{
    ...
    public sealed class Animator_GetNextAnimatorClipInfoCount_Int32_Node : BTActionNode<UnityEngine.Animator>
    {
        [Space]
        ...
        {
            var result = ((UnityEngine.Animator)MyAgent).GetNextAnimatorClipInfoCount(layerIndex);
