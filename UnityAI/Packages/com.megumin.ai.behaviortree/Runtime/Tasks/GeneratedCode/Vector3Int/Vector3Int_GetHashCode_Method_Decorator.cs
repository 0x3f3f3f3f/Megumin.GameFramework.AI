...
{
    [DisplayName("Vector3Int_GetHashCode")]
    [Category("UnityEngine/Vector3Int")]
    [AddComponentMenu("GetHashCode")]
    public sealed class Vector3Int_GetHashCode_Method_Decorator : CompareDecorator<int>
    {
        [Space]
        ...
        {
            var result = ((UnityEngine.Vector3Int)MyAgent).GetHashCode();
