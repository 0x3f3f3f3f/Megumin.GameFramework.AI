...
namespace Megumin.AI.BehaviorTree
{
    ...
    [AddComponentMenu("BoxCast(Vector2, Vector2, Single, Vector2, Single)")]
    public sealed class Physics2D_BoxCast_Vector2_Vector2_Single_Vector2_Single_Node : BTActionNode
    {
        [Space]
        ...
        {
            var result = UnityEngine.Physics2D.BoxCast(origin, size, angle, direction, distance);
