...
namespace Megumin.AI.BehaviorTree
{
    ...
    [AddComponentMenu("Raycast(Vector2, Vector2, Single, Int32)")]
    public sealed class Physics2D_Raycast_Vector2_Vector2_Single_Int32_Node : BTActionNode
    {
        [Space]
        ...
        {
            var result = UnityEngine.Physics2D.Raycast(origin, direction, distance, layerMask);
